...
const SERVICES = [
  { id: 'estrategia', label: 'Estratégia de Marca e Posicionamento',   price: 7000, prazo: '5 semanas' },
  { id: 'estrategia_conteudo', label: 'Estratégia de Conteúdo e Canais', price: 2000, prazo: '2 semanas' },
...
function Calculadora({ clientName }) {
  ...
  const myBrandingPrice = {
    mybranding_marca: hasFoundation ? 4000 : 7000,
    mybranding_conteudo: hasFoundation ? 2000 : 2000
  };
        ...
        <div className="space-y-6 mb-10 md:mb-14">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {SERVICES.filter(s => s.id !== 'estrategia' && !s.id.startsWith('mybranding') && s.id !== 'sitebrand').map((service) => (
                <div
                  key={service.id}
            ...
            <div className="adv-brand-item bg-[#211F1E] text-white rounded-[28px] p-7 md:p-8 lg:p-9 shadow-[0_18px_48px_rgba(24,20,18,0.12)]">
              ...
              <div className="pt-6 flex items-end justify-between gap-5">
                ...
                <div className="font-halyard font-medium text-[#FE6942] text-[clamp(2.4rem,3.5vw,3.8rem)] leading-[.82] tracking-[-0.055em] whitespace-nowrap">
                  R$ 2.000<span className="text-[1.1rem] md:text-[1.25rem] tracking-normal text-white/55 font-light"> /mês</span>
