      ...
      <div className="max-w-[1400px] mx-auto">
        <div className="mb-12 md:mb-14">
          ...
          <h2 className="font-editorial font-normal text-[#181412] text-[clamp(2.5rem,4vw,3.75rem)] leading-[1.02] tracking-tight">
            Chega de ficar preso a mensalidades abusivas
          </h2>
        </div>
        ...
        <div className="flex flex-col gap-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Outras Consultorias */}
            <div className="dore-item bg-[#FFF5F5] border border-red-200/50 rounded-2xl px-8 py-8 flex flex-col gap-4">
              <div className="w-12 h-12 shrink-0 rounded-full bg-red-100/50 flex items-center justify-center text-red-500">
              ...
              <div>
                <h3 className="font-halyard font-semibold text-[#181412] text-[22px] md:text-[24px] leading-[1.2] mb-3">
                  Outras Consultorias
                </h3>
            ...
            {/* Nosso Modelo */}
            <div className="dore-item bg-[#F5FFF8] border border-green-200/50 rounded-2xl px-8 py-8 flex flex-col gap-4">
              <div className="w-12 h-12 shrink-0 rounded-full bg-green-100/50 flex items-center justify-center text-green-600">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div>
                ...
                <ul className="font-halyard font-light text-[#181412] text-[18px] md:text-[19px] leading-[1.6] space-y-2">
                  <li className="flex items-start gap-2"><span className="text-green-500 mt-1">•</span> <span><b>ZERO mensalidade:</b> Sem cobrança de manutenção.</span></li>
                  <li className="flex items-start gap-2"><span className="text-green-500 mt-1">•</span> <span><b>Hospedagem inclusa:</b> Servidor por nossa conta.</span></li>
                  <li className="flex items-start gap-2"><span className="text-green-500 mt-1">•</span> <span><b>100% seu:</b> O site e o domínio são completamente seus.</span></li>
                  <li className="flex items-start gap-2"><span className="text-green-500 mt-1">•</span> <span><b>Sob demanda:</b> Alterações avulsas de R$ 100 a R$ 300.</span></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="dore-item bg-[#0a0a0a] rounded-2xl px-10 py-10 flex flex-col">
            <p className="font-editorial font-normal text-white text-[28px] md:text-[32px] leading-[1.2] tracking-tight mb-4">
              O único custo que você terá é a renovação anual do seu domínio.
            </p>
            <p className="font-halyard font-light text-white/65 text-[19px] md:text-[20px] leading-[1.5]">
              Que varia de R$ 80 a R$ 150/ano. Nada a mais.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="est-item grid grid-cols-1 lg:grid-cols-3 gap-3 mb-10 md:mb-14">
          {[
            {
              num: '01',
              titulo: 'A Fundação: A Nossa Diferença e Pesquisa',
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          ...
          <div className="mb-item bg-[#F8F8F8] rounded-2xl px-7 py-8 border border-black/[0.07]">
            ...
            <ul className="space-y-4">
              {[
                'A Nossa Diferença e imersão pessoal (metodologia BeOne)',
          ...
          <div className="flex-[0.8] bg-[#0a0a0a] rounded-2xl p-10 md:p-14 text-white flex flex-col justify-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-start gap-2 mb-8 md:mb-10">
                ...
                <span className="font-editorial text-[clamp(4.5rem,7vw,6.5rem)] leading-none text-white tracking-tight">2.000</span>
              </div>
              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-4">
                  <div className="w-[6px] h-[6px] rounded-full bg-[#FE6942] mt-2 shrink-0" />
                  <p className="font-halyard text-[17px] md:text-[19px] text-white/70 leading-[1.4]">
                    <strong className="text-white font-medium block md:inline mb-1 md:mb-0 md:mr-2">À vista:</strong> R$ 1.900 (5% de desconto).
                  </p>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-[6px] h-[6px] rounded-full bg-[#FE6942] mt-2 shrink-0" />
