    ...
    pilares: [
      {
        ...
        descricao: 'É aqui que nos aprofundamos e entendemos de forma completa o produto, o mercado e quem vai comprar.',
        itens: [
          {
            titulo: 'Imersão Estratégica',
            descricao: 'Mapeamento completo do produto, diferenciais técnicos, visão dos founders e objetivos de lançamento no mercado USD.',
          },
          {
            titulo: 'Pesquisa de Mercado Internacional',
            descricao: 'Como os concorrentes se posicionam, onde estão os padrões e quais brechas estratégicas existem para ocupar no mercado de trading.',
          },
          {
            titulo: 'Mapeamento Profundo de Público',
            descricao: 'Perfis de trader com dores, motivações, objeções e linguagem de cada um — a base que orienta toda decisão de comunicação.',
          },
        ],
      },
      {
        ...
        descricao: 'Baseado no diagnóstico, construímos uma estratégia para a marca se diferenciar da concorrência e gerar desejo no público.',
        itens: [
          {
          ...
          },
          {
            ...
            descricao: 'Propósito, valores, crenças e arquétipos que sustentam toda a comunicação e constroem confiança no mercado.',
          },
          {
            titulo: 'Estratégia de Canais',
            descricao: 'Como a marca deve se portar no Twitter/X, Instagram, landing page e ads para o mercado USD — inclui postura sobre disclaimers e credibilidade.',
          },
        ],
      },
      {
        label: 'Pilar 3',
        titulo: 'Naming',
        descricao: 'O nome é a base de tudo. Não saímos daqui sem um nome sólido, registrável e com potencial de se tornar referência.',
        itens: [
          {
            titulo: 'Arquitetura de Marca',
            descricao: 'Como a marca, a plataforma e os produtos se relacionam — nomes que funcionam juntos e reforçam o posicionamento.',
          },
          {
            titulo: 'Criação de Nome da Marca',
            descricao: 'Nome registrável, funcional em inglês e proprietário. Não apenas descritivo — diferente de tudo que existe no nicho.',
          },
          {
            titulo: 'Naming dos Produtos',
            descricao: 'Nomes para o dashboard e o indicador que reforçam o posicionamento e diferenciam dos concorrentes genéricos.',
          },
        ],
      },
      {
        ...
        descricao: 'O sistema visual e verbal que o time vai usar para construir o site e rodar os criativos com consistência.',
        itens: [
          {
            titulo: 'Identidade Verbal',
            descricao: 'Tom de voz, linguagem por perfil de trader e diretrizes de comunicação — inclusive como tratar disclaimers de forma que construa credibilidade.',
          },
          {
            titulo: 'Identidade Visual',
            descricao: 'Logo, paleta, tipografia e sistema visual base. Tudo que a equipe precisa para executar o site e os criativos com consistência.',
          },
          {
            titulo: 'Briefing de Execução',
            descricao: 'Documento de briefing da marca para o time executar o site — o que comunicar, como se posicionar em cada seção e direcionamento visual.',
          },
        ],
      },
    ],
      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="mb-16 md:mb-20">
          ...
          <h2 className="font-editorial font-normal text-[#181412] text-[clamp(2.5rem,4vw,3.5rem)] leading-[1.05] tracking-tight">
            O projeto de {PROPOSTA_DATA.cliente}
          </h2>
        </div>
...
function FoundationHouse() {
  return (
    <section className="bg-white h-full flex items-center justify-center px-2 md:px-6 lg:px-10 py-6">
      ...
      >
        <defs>
          <linearGradient id="aRoof" x1="720" y1="54" x2="720" y2="382" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#DADDE0" />
            <stop offset="1" stopColor="#ECEEEF" />
          </linearGradient>
          <linearGradient id="aWall" x1="720" y1="388" x2="720" y2="655" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#FBFBFB" />
            <stop offset="1" stopColor="#F2F3F3" />
          </linearGradient>
          <linearGradient id="aBase" x1="370" y1="655" x2="1070" y2="765" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#1D1F20" />
            <stop offset="1" stopColor="#0A0A0A" />
          </linearGradient>
          <filter id="aShadow" x="300" y="635" width="840" height="170" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
        ...
        <polygon points="720,54 354,382 1086,382" fill="url(#aRoof)" />
        <rect x="372" y="388" width="696" height="267" fill="url(#aWall)" />
        ...
        <rect x="370" y="635" width="700" height="130" rx="5" fill="url(#aBase)" filter="url(#aShadow)" />
        ...
        <text x="720" y="304" textAnchor="middle" fontFamily="'Halyard Display',sans-serif" fontSize="18" fontWeight="400" fill="#181412" fillOpacity="0.68">(TWITTER/X, INSTAGRAM,</text>
        <text x="720" y="332" textAnchor="middle" fontFamily="'Halyard Display',sans-serif" fontSize="18" fontWeight="400" fill="#181412" fillOpacity="0.68">LANDING PAGE, ADS)</text>
        ...
        <text x="720" y="548" textAnchor="middle" fontFamily="'Halyard Display',sans-serif" fontSize="22" fontWeight="700" fill="#181412">IDENTIDADE VISUAL,</text>
        <text x="720" y="580" textAnchor="middle" fontFamily="'Halyard Display',sans-serif" fontSize="22" fontWeight="700" fill="#181412">NARRATIVA E COMUNICAÇÃO</text>
        <text x="720" y="715" textAnchor="middle" fontFamily="'Halyard Display',sans-serif" fontSize="26" fontWeight="400" fill="white" fillOpacity="0.9">Estratégia de posicionamento e marca</text>
...
function Cronograma() {
  ...
  return (
    <section ref={sectionRef} className="bg-white pt-24 pb-28 md:py-36 px-6 md:px-12 lg:px-16" style={{ minHeight: '100svh', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
  ...
  return (
    <section ref={sectionRef} className="bg-white pt-16 pb-28 md:pt-20 md:pb-28 px-6 md:px-12 lg:px-16">
      <div className="max-w-[1400px] mx-auto">
        ...
        {[
          { num: '01', nome: 'Estratégia de Posicionamento e Marca', desc: 'Diagnóstico, pesquisa de mercado internacional, mapeamento de público, posicionamento, narrativa e personalidade da marca.', price: 'R$5.000' },
          { num: '02', nome: 'Naming', desc: 'Arquitetura de marca, criação do nome da empresa e dos produtos, validação de registro.', price: 'R$2.500' },
          { num: '03', nome: 'Identidade Visual e Verbal', desc: 'Criação de um sistema visual sólido e diferente (logo, paleta, tipografia, elementos), identidade verbal e direcionamento visual do site e da plataforma.', price: 'R$4.000' },
        ].map(({ num, nome, desc, price }) => (
          <div key={num} className="inv-block bg-[#F8F8F8] rounded-[24px] px-8 md:px-12 py-10 border border-black/[0.08] flex flex-col md:flex-row md:items-center gap-8 md:gap-16 mb-5 transition-shadow duration-500 hover:shadow-lg">
            <span className="font-editorial font-normal text-[#FE6942]/25 text-[4rem] md:text-[5rem] leading-none shrink-0 select-none">{num}</span>
            <div className="flex-1 min-w-0">
              <h3 className="font-halyard font-medium text-[#181412] text-[1.75rem] md:text-[2.25rem] leading-[1.1] mb-3">{nome}</h3>
              <p className="font-halyard font-normal text-[#181412] text-[18px] md:text-[20px] leading-[1.45] max-w-[52ch]">{desc}</p>
            </div>
            <div className="shrink-0 md:text-right">
              <div className="font-halyard font-medium text-gradient text-[1.75rem] md:text-[2.25rem] leading-[1]">{price}</div>
            </div>
          </div>
        ))}
        ...
        <div className="inv-block rounded-[24px] px-8 md:px-12 py-8 flex flex-col md:flex-row md:items-center gap-4 md:gap-16 mb-5" style={{ background: 'linear-gradient(135deg, #FED1C5 0%, #FF5224 100%)' }}>
          <span className="font-halyard font-semibold text-white text-[16px] tracking-[0.15em] uppercase shrink-0">Total do projeto</span>
          <div className="flex-1" />
          <div className="font-halyard font-medium text-white text-[1.75rem] md:text-[2.5rem] leading-[1]">R$11.500</div>
        </div>
...
// ── SLIDESHOW ─────────────────────────────────────────────────────────────────
// Slide 0: Capa  |  1-2: Contexto  |  3: Escopo  |  4: FoundationHouse
// 5: Resultados  |  6: Entregáveis |  7: Cronograma | 8: Pergunta | 9: Investimento
  ...
  return (
    <div className="relative overflow-hidden bg-white" style={{ height: '100svh' }}>
      ...
      >
        ...
        {current === 6 && <Entregaveis />}
        {current === 7 && <Cronograma />}
        {current === 8 && <PropostaQuestion />}
        {current === 9 && <Investimento />}
      </div>

      {/* Scroll fade hint — atrás das setas (z-10 < z-20) */}
      <div
        className="absolute bottom-0 left-0 right-0 h-24 pointer-events-none z-10 transition-opacity duration-300"
        style={{ opacity: hasMoreBelow ? 1 : 0, background: `linear-gradient(to top, ${isOnDark ? 'rgba(10,10,10,0.95)' : 'rgba(255,255,255,0.95)'} 0%, transparent 100%)` }}
        aria-hidden="true"
      />
      ...
      <div className="absolute bottom-2 md:bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-3 z-20">
        <button
          ...
          style={{
            border: `1px solid ${isOnDark ? 'rgba(255,255,255,.2)' : 'rgba(0,0,0,.15)'}`,
            background: isOnDark ? 'rgba(255,255,255,.1)' : 'rgba(255,255,255,.9)',
            backdropFilter: 'blur(8px)',
          }}
        >
          <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
            <path d="M10 12L6 8l4-4" stroke={isOnDark ? 'white' : '#181412'} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
          ...
          {Array.from({ length: SLIDE_TOTAL }).map((_, i) => (
            <div
              ...
              style={{
                ...
                height: '5px',
                backgroundColor: i === current ? '#FE6942' : (isOnDark ? 'rgba(255,255,255,.3)' : 'rgba(0,0,0,.14)'),
              }}
            />
          ))}
        </div>
...
// ── PÁGINA ────────────────────────────────────────────────────────────────────
export default function PropostaAlexandria() {
  useEffect(() => {
