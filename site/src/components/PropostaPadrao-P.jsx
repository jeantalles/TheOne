...
// 0: Capa | 1: Dores | 2: SobreTheOne | 3: Jean | 4: Zenic | 5: Thunders | 6: Camilla | 7: TheOne Foundation | 8: Casa da Marca | 9: Estratégia | 10: Naming | 11: Identidade | 12: myBranding | 13: SiteBrandExperience | 14: TheOne Agent | 15: Cronograma | 16: Calculadora | 17: Consultoria
const SLIDE_TOTAL = 18;
  ...
  return (
    ...
    >
      ...
      >
        ...
        {current === 13 && <SiteBrandExperience />}
        {current === 14 && <TheOneAgent />}
        {current === 15 && <Cronograma />}
        {current === 16 && <Calculadora />}
        {current === 17 && <Consultoria />}
      </div>
      ...
      <div
        ...
        style={{
          ...
          background: `linear-gradient(to top, ${([0, 2, 3, 4, 5, 6, 7, 14].includes(current)) ? 'rgba(10,10,10,0.95)' : 'rgba(255,255,255,0.95)'} 0%, transparent 100%)`,
        }}
        aria-hidden="true"
      />
