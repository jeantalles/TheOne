  ...
  return (
    <section ref={sectionRef} className="bg-white pt-16 pb-28 md:pt-20 md:pb-28 px-6 md:px-12 lg:px-16">
      <div className="max-w-[1400px] mx-auto">
        ...
        {/* Card 1: Projetos */}
        <div className="inv-block bg-[#F8F8F8] rounded-[24px] px-8 md:px-12 py-10 border border-black/[0.08] mb-5 transition-shadow duration-500 hover:shadow-lg">
          <span className="font-editorial font-normal text-[#FE6942]/25 text-[4rem] md:text-[5rem] leading-none shrink-0 select-none">01</span>
          <div className="mt-2 mb-8">
            ...
            <p className="font-halyard font-normal text-[#181412] text-[18px] md:text-[20px] leading-[1.45] max-w-[52ch]">
              Duas profundidades possíveis para construir a estratégia da marca e posicionamento.
            </p>
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl px-6 py-7 border border-black/[0.08]">
              <div className="font-halyard text-[12px] tracking-[0.2em] uppercase text-[#181412]/40 mb-3">Estratégia</div>
              <h4 className="font-halyard font-medium text-[#181412] text-[1.45rem] md:text-[1.75rem] leading-[1.1] mb-3">
                TheOne Foundation
              </h4>
              <p className="font-halyard font-light text-[#181412] text-[17px] md:text-[18px] leading-[1.42] mb-6">
                Diagnóstico, pesquisa, posicionamento, narrativa, estratégia de canais e conteúdo, guia estratégico e TheWoking Agent.
              </p>
              ...
              <div className="font-halyard font-light text-[16px] text-[#181412]/65">
                À vista com 10%: <span className="font-medium text-[#181412]">R$ 10.800</span>
              </div>
            </div>

            <div className="bg-white rounded-2xl px-6 py-7 border-2 border-[#FE6942]">
              <div className="font-halyard text-[12px] tracking-[0.2em] uppercase text-[#FE6942] mb-3">Mais completo</div>
              <h4 className="font-halyard font-medium text-[#181412] text-[1.45rem] md:text-[1.75rem] leading-[1.1] mb-3">
                TheOne Foundation +
              </h4>
              <p className="font-halyard font-light text-[#181412] text-[17px] md:text-[18px] leading-[1.42] mb-6">
                Tudo do Foundation, com identidade verbal aplicada: tom de voz, mensagens-chave, vocabulário proprietário e exemplos de comunicação por canal.
              </p>
              <div className="font-halyard font-medium text-gradient text-[2.35rem] md:text-[2.8rem] leading-[1] mb-2">
                R$ 18.000
              </div>
              <div className="font-halyard font-light text-[16px] text-[#181412]/65">
                À vista com 10%: <span className="font-medium text-[#181412]">R$ 16.200</span>
              </div>
            </div>
          </div>
        </div>

        {/* Card 2: Consultoria de Acompanhamento */}
        <div className="inv-block bg-[#F8F8F8] rounded-[24px] px-8 md:px-12 py-10 border border-black/[0.08] mb-5">
          <div className="flex flex-col md:flex-row md:items-start gap-8 md:gap-16">
            <span className="font-editorial font-normal text-[#FE6942]/25 text-[4rem] md:text-[5rem] leading-none shrink-0 select-none">02</span>
            <div className="flex-1 min-w-0">
              ...
              <p className="font-halyard font-normal text-[#181412] text-[18px] md:text-[20px] leading-[1.45] max-w-[52ch] mb-8">
                Suporte estratégico para colocar o posicionamento em prática após a entrega do Foundation, com encontros regulares e suporte direto no WhatsApp.
              </p>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-white rounded-2xl px-6 py-6 border border-black/[0.08]">
                  <div className="font-halyard text-[12px] tracking-[0.2em] uppercase text-[#181412]/40 mb-3">3 meses</div>
                  <div className="font-halyard font-medium text-gradient text-[2rem] md:text-[2.5rem] leading-[1] mb-2">
                    R$ 2.500/mês
                  </div>
                  <div className="font-halyard font-light text-[15px] text-[#181412]/65 mb-4">
                    Total: <span className="font-medium text-[#181412]">R$ 7.500</span><br />
                    À vista com 10%: <span className="font-medium text-[#181412]">R$ 6.750</span>
                  </div>
                ...
                <div className="bg-white rounded-2xl px-6 py-6 border-2 border-[#FE6942]">
                  <div className="font-halyard text-[12px] tracking-[0.2em] uppercase text-[#FE6942] mb-3">6 meses</div>
                  <div className="font-halyard font-medium text-gradient text-[2rem] md:text-[2.5rem] leading-[1] mb-2">
                    R$ 2.000/mês
                  </div>
                  <div className="font-halyard font-light text-[15px] text-[#181412]/65 mb-4">
                    Total: <span className="font-medium text-[#181412]">R$ 12.000</span><br />
                    À vista com 10%: <span className="font-medium text-[#181412]">R$ 10.800</span>
                  </div>
                  <ul className="space-y-1.5 mt-4">
                    {['2 encontros mensais', 'Suporte via WhatsApp', 'Direcionamento de conteúdo'].map((f) => (
        ...
        {/* Simulações */}
        <div className="inv-block bg-[#F8F8F8] rounded-[24px] px-8 md:px-12 py-10 border border-black/[0.08] mb-5">
          <div className="flex flex-col md:flex-row md:items-start gap-8 md:gap-16 mb-8">
            <span className="font-editorial font-normal text-[#FE6942]/25 text-[4rem] md:text-[5rem] leading-none shrink-0 select-none">03</span>
            <div className="flex-1 min-w-0">
              <h3 className="font-halyard font-medium text-[#181412] text-[1.75rem] md:text-[2.25rem] leading-[1.1] mb-3">
                Simulações com acompanhamento
              </h3>
              <p className="font-halyard font-normal text-[#181412] text-[18px] md:text-[20px] leading-[1.45] max-w-[58ch]">
                Valores totais considerando projeto + acompanhamento. Pagamento à vista recebe condição especial de 10% sobre o valor total.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            {[
              ['Foundation e 3 meses', 'R$ 19.500', 'R$ 17.550'],
              ['Foundation e 6 meses', 'R$ 24.000', 'R$ 21.600'],
              ['Foundation+ e 3 meses', 'R$ 25.500', 'R$ 22.950'],
              ['Foundation+ e 6 meses', 'R$ 30.000', 'R$ 27.000'],
            ].map(([name, total, cash]) => (
              <div key={name} className="bg-white rounded-2xl px-5 py-6 border border-black/[0.08]">
                <div className="font-halyard font-medium text-[#181412] text-[20px] leading-[1.15] mb-4">
                ...
                <div className="font-halyard font-medium text-[#181412] text-[28px] leading-[1] mb-4">{total}</div>
                <div className="font-halyard text-[12px] tracking-[0.18em] uppercase text-[#FE6942] mb-1">À vista com 10%</div>
                <div className="font-halyard font-medium text-gradient text-[30px] leading-[1]">{cash}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="inv-block bg-[#F8F8F8] rounded-2xl px-8 md:px-10 py-7 border border-black/[0.08]">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 mb-5">
            {[
              ...
              ['Disponibilidade de início', '18/05'],
